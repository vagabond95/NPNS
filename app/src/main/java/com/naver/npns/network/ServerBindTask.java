...
import com.naver.npns.model.PushRecvInterface;
...
public class ServerBindTask extends AsyncTask<OnMsgIncomedListener, String, Boolean> {
    ...
    protected Boolean doInBackground(OnMsgIncomedListener... listener) {
        ...
        PushRecvInterface pushApi = new PushRecvInterface(listener[0]);
